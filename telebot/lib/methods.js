...
const methods = {
  ...
  inlineButton(text, opt = {}) {
    ...
    if (opt.inlineCurrent !== undefined)
      markup.switch_inline_query_current_chat = opt.inlineCurrent;
  ...
  setGameScore: {
    ...
    options(form, opt = {}) {
      ...
      if (opt.disableEditMessage)
        form.disable_edit_message = opt.disableEditMessage;
      return form;
    },
  },
  ...
  sendInvoice: {
    ...
    options(form, opt = {}) {
      ...
      if (need.shippingAddress === true)
        form.need_shipping_address = need.shippingAddress;
  ...
  restrictChatMember: {
    ...
    options(form, opt) {
      ...
      if (opt.canSendMediaMessages)
        form.can_send_media_messages = opt.canSendMediaMessages;
      if (opt.canSendOtherMessages)
        form.can_send_other_messages = opt.canSendOtherMessages;
      if (opt.canAddWebPagePreviews)
        form.can_add_web_page_previews = opt.canAddWebPagePreviews;
      return form;
    },
  },
  ...
  answerInlineQuery: {
    ...
    arguments(answers) {
      ...
      if (answers.pmParameter !== undefined)
...
function sendFile(type, file, opt = {}, methodForm = {}, methodUrl) {
  ...
  return this.request(`/${url}`, null, form).then(
